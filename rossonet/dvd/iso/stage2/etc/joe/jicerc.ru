...
-asis		Символы с кодами 128 - 255 показывать без преобразований
 ...
 -break_links	Удалять файл перед записью, для разрыва жестких ссылок.
...
-joe_state     Использовать файл сохранения состояния ~/.joe_state
 ...
 -bg_text color	
		Установить цвет фона для текста, подсказки, меню, запросов и сообщений.
 -bg_help color	
		Установить цвет фона для подсказки.
 -bg_menu color	
		Установить цвет фона для меню.
 -bg_prompt color
		Установить цвет фона для подсказок.
 -bg_msg color	
		Установить цвет фона для сообщений.

		Например: -bg_text bg_blue
...
-istep 2
 ...
 Нет '.' в имени файла?  Предполагаем, что это - текстовый файл, 
 и включаем перенос слов

 Имя файла с '.'?  Вероятно, это не текстовый файл.
...
:include ftyperc
 ...
 В тексте подсказки следует использоват символы UTF-8 (а не локальные 8-ные
 символы),если joe не собран с опцией конфигурации --enable-rawhelp.
